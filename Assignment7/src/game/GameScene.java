...
public class GameScene extends PApplet{
	...
	public void draw(){
		...
		for(Rock rock : this.rocks)
			rock.display();
		this.topBarDelegate.setLabel(20-this.rocks.size(), this.height-this.plane.getY());
	...
	public void setTopBarDelegate(TopBarDelegate delegate){
		this.topBarDelegate = delegate;
	}
