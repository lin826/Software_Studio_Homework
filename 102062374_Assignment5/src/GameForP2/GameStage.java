...
public class GameStage extends JPanel {
	...
	public void setTag(String readLine) {
		this.tag.setText(readLine);
		}

	public void setSelectChunk(int i) {
		selectArea.selectChunk(i);	
	}
	
	public void setUnselectChunk(int i) {
		selectArea.unselectChunk(i);	
	}
